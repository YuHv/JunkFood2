...
public class BasketAction extends ActionSupport {
	...
	public String myDel(){
		...
		basketService.myDel(id);
		return "jump";
	}
	public String myShow(){
		//ActionContext.getContext().put("basketshow", basketService.myshow(id));
		ActionContext.getContext().getSession().put("basketshow",basketService.myshow(id) );
		return "show";
	}
}
