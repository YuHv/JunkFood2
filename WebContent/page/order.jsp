          ...
          <th>操作</th>
									...
									<tbody >
										...
										<tr>
											...
											<td>￥<s:property value="#orders.price"/>.00</td>
										...
										<s:if test="#orders.ischeckout==1"><td>未发货</td></s:if>
											<s:elseif test="#orders.ischeckout==0"><td>已发货</td></s:elseif>
											<td><a class="btn btn-danger" href="javascript:if(confirm('确实要删除该订单信息吗?'))location='OrdersAction!myDel?id=<s:url value="%{#orders.id}'"/>" >删除</a><br>
