	...
	<body>
		...
		<div id="content" style="background-color:#FFFFFF; height:87%;">
			...
			<div id="breadcrumb" style="width:100%;background-color:#FFFFFF;">
				...
				<a href="#">订单列表</a>
				<a href="OrdersAction!processShow" class="current">待处理订单</a>
			</div>
			<div class="widget-box" style="width:100%; background-color:#FFFFFF;">
							...
							<div class="widget-content nopadding">
								...
								<s:iterator value="#session.processOrders" id="o">
									...
									<a class="btn btn-danger"  href="javascript:if(confirm('确实要删除该订单吗?'))location='ClientAction!myDel?id=<s:property value="#c.id"/>'"><i class="icon-remove icon-white"></i> 删除</a></td>
										</tr>
									</s:iterator>
									</tbody>
								</table>							
